...
export default function LeaderboardClient() {
    ...
    // Fallback if leaderboard is empty (e.g. fresh DB)
    const displayData = leaderboard.length > 0 ? leaderboard : [
        { rank: 1, creator: "Waiting for Data...", score: 0, status: "N/A", trend: "-", img: "https://i.pravatar.cc/100?u=0" }
    ];
                ...
                <div className="max-w-6xl mx-auto space-y-16">
                    ...
                    <div className="flex flex-col lg:row items-end justify-between gap-8">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 w-full lg:w-auto">
                            {[
                                { label: 'Total Clips', value: '1.2M+' }, // This could be dynamic too, but static for now is fine
                    ...
                    {/* Podium Matrix - Show only if we have data */}
                                ...
                                <div className="order-2 md:order-1 space-y-6">
                                    <div className="relative group text-center space-y-4">
                                        <div className="size-24 mx-auto rounded-full border-2 border-white/20 p-1 relative z-10">
                                            <img src={displayData[1].img} alt="Rank 2" className="rounded-full size-full object-cover grayscale group-hover:grayscale-0 transition-all" />
                                        ...
                                        <div className="space-y-1">
                                            <h3 className="text-sm font-black uppercase tracking-widest">{displayData[1].creator}</h3>
                                            <p className="text-[10px] font-black text-white/30 uppercase tracking-widest">{displayData[1].score.toLocaleString()} PTS</p>
                                        </div>
                                ...
                                <div className="order-1 md:order-2 space-y-6 -mb-6 relative z-20">
                                    ...
                                    <div className="relative group text-center space-y-4">
                                        <div className="size-32 mx-auto rounded-full border-4 border-primary p-1.5 relative z-10 shadow-[0_0_30px_rgba(0,242,255,0.2)]">
                                            <img src={displayData[0].img} alt="Rank 1" className="rounded-full size-full object-cover" />
                                        ...
                                        <div className="space-y-2">
                                            <h3 className="text-xl font-display font-black uppercase tracking-tighter text-glow">{displayData[0].creator}</h3>
                                            <div className="inline-flex items-center gap-2 px-3 py-1 bg-primary/10 rounded-full border border-primary/20">
                                                <span className="text-[8px] font-black text-primary uppercase tracking-[0.2em]">{displayData[0].status} Tier</span>
                                            </div>
                                        </div>
                                        <div className="h-[200px] glass-card rounded-t-3xl border-primary/30 relative overflow-hidden">
                                            ...
                                            <div className="absolute top-8 left-0 right-0 text-center space-y-1">
                                                <p className="text-2xl font-display font-black text-white">{displayData[0].score.toLocaleString()}</p>
                                ...
                                <div className="order-3 space-y-6">
                                    <div className="relative group text-center space-y-4">
                                        <div className="size-24 mx-auto rounded-full border-2 border-secondary/40 p-1 relative z-10">
                                            <img src={displayData[2].img} alt="Rank 3" className="rounded-full size-full object-cover grayscale group-hover:grayscale-0 transition-all" />
                                        ...
                                        <div className="space-y-1">
                                            <h3 className="text-sm font-black uppercase tracking-widest">{displayData[2].creator}</h3>
                                            <p className="text-[10px] font-black text-white/30 uppercase tracking-widest">{displayData[2].score.toLocaleString()} PTS</p>
                                        </div>
