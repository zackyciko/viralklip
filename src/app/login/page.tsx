            ...
            <div className="relative z-10 w-full max-w-md p-8">
                <div className="glass-card rounded-3xl border-white/5 p-12 space-y-8">
                    ...
                    <div className="text-center space-y-2">
                        <h1 className="text-3xl font-display font-black uppercase tracking-tight">Neural Login</h1>
                        <p className="text-[10px] font-bold text-white/40 uppercase tracking-widest">Access Your Matrix</p>
                    </div>
