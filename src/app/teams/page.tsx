...
const teamMembers = [
    { id: 1, name: "NeonHustle", role: "Owner", avatar: "https://i.pravatar.cc/150?u=tm1", status: "Active" },
    { id: 2, name: "CyberVibe", role: "Manager", avatar: "https://i.pravatar.cc/150?u=tm2", status: "Active" },
    { id: 3, name: "MarcoEditZ", role: "Editor", avatar: "https://i.pravatar.cc/150?u=tm3", status: "Neural Sync" },
];
            ...
            <header className="relative z-50 border-b border-white/5 bg-background-dark/50 backdrop-blur-xl px-6 lg:px-12 py-4 flex items-center justify-between">
                <div className="flex items-center gap-12">
                    ...
                    <nav className="hidden lg:flex items-center gap-8">
                        ...
                        <Link href="/teams" className="text-[10px] font-black uppercase tracking-[0.2em] text-primary transition-colors">Team Flux</Link>
                    </nav>
                </div>
                ...
                <div className="max-w-7xl mx-auto space-y-12">
                    ...
                    <div className="flex flex-col lg:row items-center justify-between gap-12">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 w-full lg:w-auto">
                            {[
                                { label: 'Active Nodes', value: '03 / 05' },
                                { label: 'Shared Credits', value: '4.2k' },
                                { label: 'Sync Velocity', value: 'Ultra' },
                                { label: 'Team Rank', value: 'Apex' }
                            ].map((stat) => (
                                    ...
                                    <div key={member.id} className="group glass-card rounded-3xl border-white/5 p-6 flex items-center justify-between gap-6 hover:border-white/20 transition-all">
                                        <div className="flex items-center gap-6">
                                            <div className="size-16 rounded-2xl overflow-hidden border border-white/10 group-hover:border-primary/30 transition-colors">
                                                <img src={member.avatar} alt={member.name} className="size-full object-cover group-hover:scale-110 transition-transform duration-500" />
                                            </div>
                                            <div className="space-y-1">
                                                <h4 className="text-lg font-black uppercase tracking-widest text-white group-hover:text-primary transition-colors">{member.name}</h4>
                            ...
                            <div className="p-8 glass-card rounded-3xl border-white/5 space-y-8">
                                ...
                                <div className="space-y-6">
                                    <div className="space-y-3">
                                        ...
                                        <input className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-3 text-xs font-bold focus:outline-none focus:border-primary/30 transition-all" value="Matrix Elite One" />
                                    </div>
                                    <div className="space-y-3">
                                        ...
                                        <div className="p-4 glass-card rounded-xl border-primary/20 bg-primary/5 flex items-center justify-between">
                                            <span className="text-[10px] font-black text-primary uppercase">Creator Pro</span>
                                ...
                                <div className="pt-8 border-t border-white/5 space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="w-full h-1 bg-white/10 rounded-full overflow-hidden">
                                            <div className="h-full bg-secondary w-[82%] shadow-[0_0_10px_rgba(123,47,247,0.5)]"></div>
                                        </div>
                                    </div>
                                </div>
